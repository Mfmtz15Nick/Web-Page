    ...
    if(mysqli_num_rows($resConsulta)>0){
        ...
        while ($regConsulta=mysqli_fetch_array ($resConsulta)) {
           ...
           // $actualiza="UPDATE `reportealumnos` SET `asistencias`= 2 WHERE ncontrol='$ncontrol";
            $actualiza="Update `reportealumnos` Set asistencias='$asistencias' Where ncontrol='$ncontrol'";
        ...
        $inserta="INSERT INTO `reportealumnos` (`identificador`, `periodo`, `ncontrol`, `nombre`, `materia`, `grupo`, `faltas`, `asistencias`) VALUES (NULL, '$periodo', '$ncontrol', '$nombre', '$materia', '$grupo', '0', '1')";
