...
include 'conexiones.php';
    ...
    $con=conecta();
    $consulta="select * from reportealumnos where periodo='".$periodo."' and materia='".$materia."' and grupo='".$grupo."' order by asistencias desc";
    ...
    if($resConsulta){ 
		...
		while($registro=mysqli_fetch_array($resConsulta)){
			...
			$tabla.= "<td>".$registro["asistencias"]."</td>";			
			$tabla.= "</tr>";
		}
		$tabla.= "</tbody>";
	}else{
